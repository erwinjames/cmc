                                   ...
                                   <ul >
                                        <li style="margin-left:14px;" >
                                         ...
                                         <li class="current active">
                                            <a href="Associate.php"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Time Deposit</a>
                                        </li>
                                        <br>
                                        <li>
                    ...
                    <div class="col-8  col-12-narrower imp-narrower">
                        <div id="content">
                            ...
                            <button class="colapse">Requirements</button>
                                ...
                                <button class="colapse">Interest Rate</button>
                                <div class="contenting">
                                ...
                                <button class="colapse">Renewal</button>
                                <div class="contenting">
                                ...
                                <button class="colapse">Closing</button>
                                <div class="contenting">
