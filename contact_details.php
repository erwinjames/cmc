...
<body class="is-preload">
    ...
    <ul>
        ...
        <section id="cta" class="wrapper style2">
            <div class="container">
                <header>
                    <h2>CONTACT US / CONTACT DETAILS</h2>
                </header>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-6 col-12-narrower">
                        <div class="card" data-aos="fade-up" data-aos-duration="1000">
                            <div class="imgBx">
                                <img src="images/building_nav.png" alt="">
                            </div>
                            <div class="details">
                                <div class="contents">
                                    <h2>Main Branch</h2>
                                    <span>Location : Poblacion Cordova Cebu</span><br>
                        ...
                        <div class="card" data-aos="fade-up" data-aos-duration="2000">
                            ...
                            <div class="details">
                                <div class="contents">
                                    ...
                                    <span>Building : Jober Electronics Parts & Electrical Supplies Building</span>
                                    <br>
                                    <span>Telephone # : </span><br>
                    ...
                    <div class="col-6 col-12-narrower">
                        <div class="card" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="details">
                                <div class="contents">
                                    <h2>Basak Branch</h2>
                                    <span>Location :Basak Lapu-Lapu</span>
                                    <br>
                                    <span>Telephone # : </span><br>
                    ...
                    <div class="col-6 col-12-narrower">
                        <div class="card" data-aos="fade-up" data-aos-duration="2000">
                            ...
                            <div class="details">
                                <div class="contents">
                                    <h2>Olango Branch </h2>
                                    <span>Location : Sta. Rosa Proper, Sta. Rosa, Olanggo, 6015 Cebu</span>
                                    <br>
                                    <span>Telephone # : </span><br>
                ...
                <div class="row">
                        ...
                        <div class="card" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="details">
                                <div class="contents">
                                    ...
                                    <span>Location : Mandaue City, Central Visayas</span>
                                    <br>
                                    <span>Telephone # : </span><br>
                    ...
                    <div class="col-6 col-12-narrower">
                        <div class="card" data-aos="fade-up" data-aos-duration="2000">
                            ...
                            <div class="details">
                                <div class="contents">
                                    <h2>Lumber and Consumer</h2>
                                    <span>Location : Poblacion Cordova</span>
                                    <br>
                                    <span>Telephone # : </span><br>
