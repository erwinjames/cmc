...
<body class="is-preload">
    ...
    <div id="page-wrapper">
        ...
        <div id="header">
            ...
            <div class="row">
                <div class=" logo">
                    <img width="2%" src="images/cmc.png" alt="">
                </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="awardsAndRecognation.html">Awards and Recognations</a></li>
                            <li><a href="officers/coop_officers.html">Officers</a></li>
                            <li><a href="OrganizationalStructure.html">Organization Structure</a></li>
        ...
        <section id="cta" class="wrapper style2">
            <div class="container">
                <header>
                    <h2>PRODUCTS AND SERVICES / HEALTHCARE</h2>
                </header>
            </div>
        </section>
