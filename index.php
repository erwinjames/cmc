                ...
                <div class="row gtr-200">
                    ...
                    <section class="col-4 col-12-narrower">
                        <div class="box highlight" data-aos="fade-up" data-aos-duration="2000">
                            <i class="icon solid major"><img src="images/loan_products.png" alt=""></i>
                            <h3>Loan Products</h3>
                    ...
                    <section class="col-4 col-12-narrower">
                        <div class="box highlight" data-aos="fade-up" data-aos-duration="3000">
                            <i class="icon solid major"><img src="images/loan.png" alt=""></i>
        ...
        <section id="cta" class="wrapper style3">
            <div class="container"> 
                <header data-aos="fade-left" data-aos-duration="1500">
                    <h2>HOW TO BECOME A MEMBER?</h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="Membership/regular_membership.php" class="button">Click me</a>
                </header>
            </div>
        </section>
        <!-- Footer -->
